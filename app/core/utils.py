...
from app.core.config import CHUNK_SIZE, get_settings, UPLOAD_BASES_PATH
from app.models.model import HistoricoModel
from app.repository.repository_historico_modelo import insert_historico_modelo
...
def load_upload_file():
    ...
    arquivos_disponiveis = ["Selecione um arquivo..."] + [ f for f in UPLOAD_BASES_PATH if f.endswith(".csv") ]
